...
class NamesComparator implements Comparator<Employee>{
...
class SalarysComparator implements Comparator<Employee>{
...
public class LinkedListWithComparator {
	...
	public static void main(String[] args) {
		...
		Collections.sort(al, new SalarysComparator());
		for(Employee emp:al) {
			System.out.println(emp.getEid()+" "+emp.getEname()+" "+emp.getEsal());
		}
	}
